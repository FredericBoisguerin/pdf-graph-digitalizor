...
public class BezierCurveDiscretizerWithAngleThresholdTestSimpleInflexionUp
        extends AbstractBezierCurveDiscretizerWithAngleThresholdTest {

    private final DrawingPoint p0 = new DrawingPoint(0, 0);
    private final DrawingPoint p1 = new DrawingPoint(1, 2);
    private final DrawingPoint p2 = new DrawingPoint(2, 0);
