 ...
 */
public class BezierCurveDiscretizerWithAngleThreshold implements BezierCurveDiscretizer {

    private final int angleThreshold;

    public BezierCurveDiscretizerWithAngleThreshold(int angleThreshold) {
    ...
    private double angleBetween(float t, float nextT, BezierCurve bezierCurve) {
     ...
     */
    private static double getAngle(DrawingPoint drawingPointA, DrawingPoint drawingPointC, DrawingPoint drawingPointB) {
